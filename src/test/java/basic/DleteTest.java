...
public class DleteTest {
    ...
    @Test
    @DisplayName("Verify delete project")
    public void verifyCreateUpdateProject() throws InterruptedException {
        ...
        Assertions.assertTrue(chrome.findElements(By.id("ctl00_HeaderTopControl1_LinkButtonLogout")).size() ==1,
                "ERROR! nose pudo iniciar la sesion");

        // create project
        // click add new project
        String nameProject = "WendyPrueba2";
        ...
        String nameProjectUpdated = "WendyActualizado";
        ...
        // delete project
        //select project created
        chrome.findElement(By.xpath("//li[last()]//td[text()='"+nameProjectUpdated+"'] ")).click();
        // click menu icon
        chrome.findElement(By.xpath("//div[@style=\"display: block;\"]/img")).click();
        // click  [edit]
